...
Retrieves evaluations and related data for aggregation.
"""
...
from app.db.models import Evaluation, EvaluationScore, Workflow, Role, Competency
...
class SignalsRepository:
    ...
    async def get_evaluations_for_workflows(
        self,
